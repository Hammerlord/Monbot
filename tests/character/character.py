...
class CharacterTests(unittest.TestCase):
    ...
    def test_max_level_exp_gain(self):
        ...
        self.assertEquals(character.current_exp, 0, error)
    ...
    def test_set_nickname(self):
        ...
        self.assertEquals(self.character.get_nickname(), name, error)
    ...
    def test_nickname_spaces(self):
        ...
        self.assertEquals(self.character.nickname, "hello", error)
